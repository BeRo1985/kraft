...
procedure RunArm(const aName:string;const aSolverMode:TKraftSolverMode;const aJointMode:TKraftTGSJointMode;const WithConeTwist,WithElbowLimits,MirroredRight:boolean);
...
begin
 ...
 RunArm('SI  left  full           ',ksmSequentialImpulse,ktjmAdapter,true,true,false);
 RunArm('SI  left  no-conetwist   ',ksmSequentialImpulse,ktjmAdapter,false,true,false);
 RunArm('SI  left  no-elbowlimits ',ksmSequentialImpulse,ktjmAdapter,true,false,false);
 RunArm('SI  left  bare           ',ksmSequentialImpulse,ktjmAdapter,false,false,false);
 RunArm('TGA left  full           ',ksmTGSSoft,ktjmAdapter,true,true,false);
 RunArm('TGA left  no-conetwist   ',ksmTGSSoft,ktjmAdapter,false,true,false);
 RunArm('TGA left  no-elbowlimits ',ksmTGSSoft,ktjmAdapter,true,false,false);
 RunArm('TGA left  bare           ',ksmTGSSoft,ktjmAdapter,false,false,false);
 RunArm('NAT left  full           ',ksmTGSSoft,ktjmNativeSoft,true,true,false);
end.
