...
var SweepMargin:TKraftScalar=0.10;
    RagdollAngularDamp:TKraftScalar=0.1;
...
begin
 ...
 RunSweep('SI  full damp=2.0',ksmSequentialImpulse,ktjmAdapter,1.0,true,true,true);
 RunSweep('NAT full damp=2.0',ksmTGSSoft,ktjmNativeSoft,1.0,true,true,true);
 RunSweep('TGA full damp=2.0',ksmTGSSoft,ktjmAdapter,1.0,true,true,true);
 RagdollAngularDamp:=1.0;
 RunSweep('SI  full damp=1.0',ksmSequentialImpulse,ktjmAdapter,1.0,true,true,true);
end.
